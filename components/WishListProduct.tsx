      ...
      {favoriteProduct?.length > 0 ? (
                    ...
                    <tr key={product?._id} className="border-b">
                      <td className="px-2 py-4 flex items-center gap-2">
                        <X
                          ...
                          size={18}
                          className="hover:text-red-600  hoverEffect hover:cursor-pointer"
                        />
                        {product?.images && (
                          <Link
        ...
        <div className="flex min-h-[400px] flex-col  items-center justify-center space-y-6 px-4 text-center">
          <div className="relative mb-4">
            <div className="absolute -top-1 -right-1 h-4 w-4 animate-ping rounded-full bg-muted-foreground">
              <Heart
                className="h-12 w-12 text-muted-foreground  bg-transparent "
                stroke="#063c28"
                strokeWidth={1.5}
              />
            </div>
            <div className="space-y-2">
              ...
              <Button
                className="bg-shop_btn_dark_green hover:bg-shop_btn_dark_green/80 hoverEffect"
                asChild
              >
