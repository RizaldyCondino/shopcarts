      ...
      <div className="flex flex-col md:min-w-40 border">
        {categories?.map((item) => (
          <Button
            ...
            key={item?._id}
            className={`bg-transparent border-0 p-0 rounded-none text-darkColor shadow-none border-shop_orange/20 hover:bg-shop_orange
          hover:text-white font-semibold hoverEffect border-b last:border-b-0 capitalize transition-colors 
          ${item?.slug?.current === currentSlug && "bg-shop_orange border-shop_orange text-white"}
          `}
          >
