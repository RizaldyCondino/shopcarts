      ...
      <Container className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        <div className="md:col-span-3">
          ...
          <div className="bg-shop_light_bg p-5 ">
            ...
            <div className="text-2xl font-semibold tracking-wide mt-5 line-clamp-2 hover:text-shop_dark_green hoverEffect">
              {blog?.title}
            </div>
            <div>
              {blog.body && (
                <PortableText
                  ...
                  components={{
                    block: {
                      ...
                      blockquote: ({ children }) => (
                        <blockquote
                          className="my-5 border-l-2 
                        border-l-gray-300 pl-6 text-base/8 text-gray-950 
                    ...
                    marks: {
                      ...
                      link: ({ value, children }) => {
                        return (
                          ...
                          decoration-gray-400 underline-offset-4 
