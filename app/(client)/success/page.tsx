      ...
      <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-xl w-full text-center">
        ...
        <div className="space-y-4 mb-4 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Link
              href="/orders"
              className="flex border-1 items-center justify-center px-4 py-3 font-semibold bg-white text-black rounded-lg hover:bg-shop_btn_dark_green/20 transition-all duration-300 shadow-md"
            >
